BIBLE = [
    {'OLD TESTAMENT': [
        'Genesis', 'Exodus', 'Leviticus', 'Numbers', 'Deuteronomy', 'Joshua', 'Judges', 'Judges', '1 Samuel ',
    ...
    {'NEW TESTAMENT': [
        ...
        'Philippians', 'Colossians', '2 Thessalonians', '1 Timothy', '2 Timothy', 'Titus', 'Philemon', 'Hebrews',
